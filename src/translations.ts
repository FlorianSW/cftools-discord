const messages: { [key: string]: string } = {
    ...
    BAN_EXPIRATION_DESCRIPTION: 'The date when the ban should expire or Permanent when it should be permanent',
    BAN_EXPIRATION_PERMANENT: 'Permanent',
    BAN_EXPIRATION_IN_ONE_DAY: 'In one day',
    BAN_EXPIRATION_IN_ONE_WEEK: 'In one week',
    BAN_EXPIRATION_IN_ONE_MONTH: 'In one month',
    BAN_INVALID_EXPIRATION: 'The provided expiration time is invalid. Check if it is in the future and correctly formatted and try again.',
